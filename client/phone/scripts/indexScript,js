                    ...
                    ctxSip = {  // Use global ctxSip
                        ...
                        newSession: function (newSess) {
                            ...
                            newSess.on('accepted', function (e) {
                                ...
                                $('#incomingCallModal').modal('hide'); // Hide the modal if it was shown
                                ...
                                activateSecondButton('#btnactivecall');
                                $('#inCallControls').show();
                                $('#callTimer').show();
                        ...
                        logIncomeCall: function (item) {
                            ...
                            logItem += '<div class="pull-right text-right text-right-callactive"><strong style="margin-bottom: 10px;">Unknown</strong><br><img src="../img/income.png" class="icon" alt="call icon" style="width: 150px; height: 150px; margin-bottom: 20px;"><br><strong class="name-text"  style="margin-bottom: 10px;">' + item.clid + '</strong><br><strong class="status-text">' + cllMode + '</strong><br>';
                            // logItem += '<div class="align-items-center"><img src="' + callIconSrc + '" class="icon" alt="call icon" style="width: 20px; height: 20px;  margin-right: 5px;"> <strong>' + cllMode + '</strong>';
                            // logItem += '</div>';
                            // logItem += '<div class="pull-right text-right"><strong>' + moment(item.start).format('MM/DD hh:mm:ss a') + '</strong><br>' + callLength + '</div></div></div>';
                            ...
                            if (callActive) {
                                ...
                                if (item.status === 'ringing' && item.flow === 'incoming') {
                                    ...
                                    logItem += '<div class="callTimer" style="font-size: 20px; margin-bottom: 10px;"></div>'
                                }
                        ...
                        logItem: function (item) {
                           ...
                           // i += '<div class="pull-right text-right"><strong>Unknown</strong><br><em>' + item.clid + '</em></div>';
