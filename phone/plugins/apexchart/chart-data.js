...
$(document).ready(function() {
    ...
    if ($('#gauge_chart').length > 0) {
        var options = {
            series: [76], // Set the series value to your desired value
            chart: {
                type: 'radialBar',
                height:650,
                offsetY: -20,
    ...
    // if ($('#gauge_chart').length > 0) {
    //     var gaugeCtx = document.getElementById("gauge_chart"),
    //         gaugeConfig = {
    //             chart: {
    //                 height:650,
    //                 type: 'radialBar',
    ...
    //                                 return 76 + '%';  // Replace with actual value if needed
    //                             }
    //                         }
    //                     }
    //                 }
    ...
    //             series: [76]
    //         };
    //     var gaugeChart = new ApexCharts(gaugeCtx, gaugeConfig);
    //     gaugeChart.render();
    // }
